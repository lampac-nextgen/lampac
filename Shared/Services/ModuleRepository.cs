...
namespace Shared.Services
{
    public static class ModuleRepository
    {
        ...
        private const string RepositoryDirectory = "module/Community";
        ...
        private static bool DownloadAndExtract(RepositoryEntry repository)
        {
            ...
            try
            {
                ...
                foreach (var folder in repository.Folders)
                {
                    ...
                    string destinationPath = Path.Combine(Environment.CurrentDirectory, RepositoryDirectory, folder.ModuleName);
